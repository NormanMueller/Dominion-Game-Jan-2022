...
karten_dict_class = karten([kupfer, silber, gold, anwesen, herzogentum, provinz, dorf,
        schmiede, miliz , markt])

for index in range(len( karten_dict_class.karten)) :
    setattr(karten_dict_class, karten_dict_class.card_names[index], karten_dict_class.karten[index])
 
#for index in range(len( karten_dict_class.karten)) :
 #   setattr(karten_dict_class, karten_dict_class.card_names[index], karten_dict_class.karten[index])

#getattr(karten_dict_class,'schmiede' ).get_draws_and_actions_from_action_card()
